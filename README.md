# WebCrawl
A small tool that crawls websites, scanning them for vulnerabilities, such as common misconfigurations or outdated software versions in HTTP/HTTPS headers
